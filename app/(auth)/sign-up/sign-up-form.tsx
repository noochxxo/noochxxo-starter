  ...
  return (
    <Form action={action} className="space-y-6 shadow-lg p-8 bg-card">
      ...
      <Button
        type="submit"
        disabled={pending}
        className="w-full justify-center rounded-lg bg-brand px-3 py-3 text-sm font-semibold text-white shadow-sm bg-accent/80 hover:bg-accent focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-brand"
      >
